...
class StableDiffusion(nn.Module):
    def __init__(
        ...
        # Create model use pretrained model
        ...
        if vram_O:
            ...
            pipe.to(device)
        #export pretrained model child module in order to add other module and make a new forward process
        self.vae = pipe.vae
    ...
    def train_step(
        ...
        with torch.no_grad():
            ...
            noise_pred_cond, noise_pred_uncond = noise_pred.chunk(2)
            #print('noise_pred_cond:', noise_pred_cond.shape)
...
if __name__ == "__main__":
    ...
    device = torch.device(common.global_constant.GPU.DEVICE)
